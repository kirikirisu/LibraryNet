...
export type CreateLibraryMutation = { __typename?: 'Mutation' } & {
  createLibrary: { __typename?: 'LibraryResponse' } & {
    library?: Maybe<
      { __typename?: 'Library' } & Pick<
        Library,
...
export type PublishBookMutation = { __typename?: 'Mutation' } & {
  publishBook: { __typename?: 'BookResponse' } & Pick<
    BookResponse,
    'errors'
  > & {
      book?: Maybe<
...
export type RegisterMutation = { __typename?: 'Mutation' } & {
  register: { __typename?: 'UserResponse' } & {
    user?: Maybe<
      { __typename?: 'User' } & Pick<User, 'id' | 'username' | 'slackId'>
    >;
    errors?: Maybe<
      Array<
        { __typename?: 'FieldError' } & Pick<FieldError, 'field' | 'message'>
...
export type ReturnBookMutation = { __typename?: 'Mutation' } & Pick<
  Mutation,
  'returnBook'
>;
...
export type SubscribeBookMutation = { __typename?: 'Mutation' } & {
  subscribeBook: { __typename?: 'SubscribeResponse' } & Pick<
    SubscribeResponse,
    'errors' | 'shared'
  >;
};
...
export type LibrarysQuery = { __typename?: 'Query' } & {
  librarys?: Maybe<
    Array<
      { __typename?: 'Library' } & Pick<
        Library,
        'id' | 'title' | 'description' | 'icon' | 'adminId'
      > & {
          admin: { __typename?: 'User' } & Pick<
            User,
...
export type MeQuery = { __typename?: 'Query' } & {
  me?: Maybe<
    { __typename?: 'User' } & Pick<User, 'id' | 'username' | 'hasLibrary'>
  >;
};

export type MyPublishBooksQueryVariables = Exact<{ [key: string]: never }>;

export type MyPublishBooksQuery = { __typename?: 'Query' } & {
  myPublishBooks?: Maybe<
    Array<
      { __typename?: 'Book' } & Pick<
        Book,
...
export type MySubscribeBooksQuery = { __typename?: 'Query' } & {
  mySubscribeBooks?: Maybe<
    Array<
      { __typename?: 'Book' } & Pick<
        Book,
        'id' | 'title' | 'description' | 'img' | 'inforLink' | 'available'
...
`;
export type PublishBookMutationFn = Apollo.MutationFunction<
  PublishBookMutation,
  PublishBookMutationVariables
>;
 ...
 * });
 */
export function usePublishBookMutation(
  baseOptions?: Apollo.MutationHookOptions<
    PublishBookMutation,
    PublishBookMutationVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useMutation<PublishBookMutation, PublishBookMutationVariables>(
    PublishBookDocument,
    options
  );
}
export type PublishBookMutationHookResult = ReturnType<
  typeof usePublishBookMutation
>;
export type PublishBookMutationResult = Apollo.MutationResult<PublishBookMutation>;
export type PublishBookMutationOptions = Apollo.BaseMutationOptions<
  PublishBookMutation,
  PublishBookMutationVariables
>;
...
`;
export type SubscribeBookMutationFn = Apollo.MutationFunction<
  SubscribeBookMutation,
  SubscribeBookMutationVariables
>;
 ...
 * });
 */
export function useSubscribeBookMutation(
  baseOptions?: Apollo.MutationHookOptions<
    SubscribeBookMutation,
    SubscribeBookMutationVariables
  >
  ...
  return Apollo.useMutation<
    SubscribeBookMutation,
    SubscribeBookMutationVariables
  >(SubscribeBookDocument, options);
}
export type SubscribeBookMutationHookResult = ReturnType<
  typeof useSubscribeBookMutation
>;
export type SubscribeBookMutationResult = Apollo.MutationResult<SubscribeBookMutation>;
export type SubscribeBookMutationOptions = Apollo.BaseMutationOptions<
  SubscribeBookMutation,
  SubscribeBookMutationVariables
>;
 ...
 * });
 */
export function useLibrarysQuery(
  baseOptions?: Apollo.QueryHookOptions<LibrarysQuery, LibrarysQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<LibrarysQuery, LibrarysQueryVariables>(
    LibrarysDocument,
    options
  );
}
export function useLibrarysLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    LibrarysQuery,
    LibrarysQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<LibrarysQuery, LibrarysQueryVariables>(
    LibrarysDocument,
    options
  );
}
export type LibrarysQueryHookResult = ReturnType<typeof useLibrarysQuery>;
export type LibrarysLazyQueryHookResult = ReturnType<
  typeof useLibrarysLazyQuery
>;
export type LibrarysQueryResult = Apollo.QueryResult<
  LibrarysQuery,
  LibrarysQueryVariables
>;
 ...
 * });
 */
export function useMyPublishBooksQuery(
  baseOptions?: Apollo.QueryHookOptions<
    MyPublishBooksQuery,
    MyPublishBooksQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<MyPublishBooksQuery, MyPublishBooksQueryVariables>(
    MyPublishBooksDocument,
    options
  );
}
export function useMyPublishBooksLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    MyPublishBooksQuery,
    MyPublishBooksQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<MyPublishBooksQuery, MyPublishBooksQueryVariables>(
    MyPublishBooksDocument,
    options
  );
}
export type MyPublishBooksQueryHookResult = ReturnType<
  typeof useMyPublishBooksQuery
>;
export type MyPublishBooksLazyQueryHookResult = ReturnType<
  typeof useMyPublishBooksLazyQuery
>;
export type MyPublishBooksQueryResult = Apollo.QueryResult<
  MyPublishBooksQuery,
  MyPublishBooksQueryVariables
>;
 ...
 * });
 */
export function useMySubscribeBooksQuery(
  baseOptions?: Apollo.QueryHookOptions<
    MySubscribeBooksQuery,
    MySubscribeBooksQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<MySubscribeBooksQuery, MySubscribeBooksQueryVariables>(
    MySubscribeBooksDocument,
    options
  );
}
export function useMySubscribeBooksLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    MySubscribeBooksQuery,
    MySubscribeBooksQueryVariables
  >
  ...
  return Apollo.useLazyQuery<
    MySubscribeBooksQuery,
    MySubscribeBooksQueryVariables
  >(MySubscribeBooksDocument, options);
}
export type MySubscribeBooksQueryHookResult = ReturnType<
  typeof useMySubscribeBooksQuery
>;
export type MySubscribeBooksLazyQueryHookResult = ReturnType<
  typeof useMySubscribeBooksLazyQuery
>;
export type MySubscribeBooksQueryResult = Apollo.QueryResult<
  MySubscribeBooksQuery,
  MySubscribeBooksQueryVariables
>;
